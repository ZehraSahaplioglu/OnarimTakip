...
import com.example.onarimtakip.ModelTanimlama;
import com.example.onarimtakip.R;
...
public class DropDownAdapter extends BaseAdapter {
    ...
    ArrayList<DegerIkilisi> degerListesi;

    public DropDownAdapter(Context context, ArrayList<DegerIkilisi> degerListesi) {
